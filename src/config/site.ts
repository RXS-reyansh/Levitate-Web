  ...
  commandCategories: [
    ...
    },
    {
      ...
      commands: [
        ...
        { name: '$purge',          aliases: [],                                     permission: 'Manage Messages',   description: '13+ subcommands: all, bot, user, text, images, links, between, embeds, and more.', usage: '$purge <subcommand> [args]' },
        { name: '$purge-till',     aliases: ['purgetill', 'pt'],                    permission: 'Manage Messages',   description: 'Delete all messages up to a specific message ID.',              usage: '$purge-till <message ID>' },
    ...
    },
    {
      ...
      commands: [
        ...
        { name: '$namestyle',        aliases: ['ns'],                                permission: 'Manage Server',  description: 'Set the bot\'s display name style for this server.',              usage: '$namestyle' },
        ...
        { name: '$autoresponder',    aliases: ['ares', 'autoresponders'],            permission: 'Manage Server',  description: 'Create triggers that auto-reply to matching messages.',            usage: '$autoresponder add <trigger> <response>\n$autoresponder list\n$autoresponder remove <trigger>' },
        ...
        { name: '$purge-till',       aliases: ['purgetill', 'pt'],                   permission: 'Manage Messages',description: 'Delete messages up to a specific message ID.',                     usage: '$purge-till <message ID>' },
